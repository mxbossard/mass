...
var rootCmd = &cobra.Command{
	Use:   "mass",
	Short: "My Automated ServiceS",
	Long:  `Use mass to organize your projects and automate deployment of your services from dev to prod.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mass" (without extension).
